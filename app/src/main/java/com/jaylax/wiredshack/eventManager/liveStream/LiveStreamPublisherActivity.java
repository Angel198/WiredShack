...
public class LiveStreamPublisherActivity extends AppCompatActivity implements EnxRoomObserver, EnxStreamObserver, EnxScreenShotObserver, WebResponse, EnxReconnectObserver {
    ...
    public void onRoomError(JSONObject jsonObject) {
        ...
        Toast.makeText(LiveStreamPublisherActivity.this, "Room Error", Toast.LENGTH_SHORT).show();
        this.finish();
    }
    ...
    public void onPublishedStream(EnxStream enxStream) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                enxPlayerView = new EnxPlayerView(LiveStreamPublisherActivity.this, EnxPlayerView.ScalingType.SCALE_ASPECT_BALANCED, true);
...
// received when user role changed successfully
    ...
    public JSONObject getReconnectInfo() {
        ...
        Log.e("getReconnectInfo", "getReconnectInfo");
        return jsonObject;
    }
