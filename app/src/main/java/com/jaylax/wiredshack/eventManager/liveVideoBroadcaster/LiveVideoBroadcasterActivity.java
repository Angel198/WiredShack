package com.jaylax.wiredshack.eventManager.liveVideoBroadcaster;
...
//    private ImageButton mSettingsButton;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("eventStream")){
            streamName = getIntent().getStringExtra("eventStream");
        }
...
//                                mSettingsButton.setVisibility(View.GONE);
                                ...
                                Snackbar.make(mRootView, R.string.event_not_started, Snackbar.LENGTH_LONG).show();

                                triggerStopRecording();
                            }
                        }
                    }.execute(Commons.RTMP_URL+streamName.replace(" ",""));
                } else {
