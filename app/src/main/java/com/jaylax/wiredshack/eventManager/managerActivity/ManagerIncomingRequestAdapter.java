...
public class ManagerIncomingRequestAdapter extends RecyclerView.Adapter<ManagerIncomingRequestAdapter.MyViewHolder> {
    ...
    public ManagerIncomingRequestAdapter(Context context, ArrayList<IncomingRequestMainModel.IncomingRequest> list) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(int pos, IncomingRequestMainModel.IncomingRequest data) {
            ...
            mBinding.tvRequestEventName.setText(data.getUserName() == null ? "N/A" : data.getUserName());
